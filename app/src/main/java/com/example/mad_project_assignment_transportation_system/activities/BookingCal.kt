...
class BookingCal : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_booking_cal)
...
//
    ...
    fun buttonClick(v: View){
        ...
        if(edtNumber1.text.toString().toDouble() > 10){
            when(v.id){
                R.id.btn_submit -> ans = calculator.add1()
            }
        }
        ...
        val intent = Intent(this, CalDisplay::class.java)
